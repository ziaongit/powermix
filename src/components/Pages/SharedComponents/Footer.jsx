...
const Footer = () => {
  return (
    <div className="footer text-lg-start mt-5">
      <div className="container-fluid p-4">
        <div className="row pt-4">
        <div className="col-lg-4 text-center col-md-6 mb-4 mb-md-0">
        ...
        <SocialMedia />
          ...
          <div className="col-lg-2 col-md-6 mb-4 mb-md-0">
            ...
            <ul className="list-unstyled mb-0">
              ...
              <li>
                <a href="#!" className="text-dark">Career</a>
              </li>
              <li>
          ...
          <div className="col-lg-2 col-md-6 mb-4 mb-md-0">
            <h5 className="footer-title mb-0">Service</h5>

            <ul className="list-unstyled">
              <li>
                <a href="#!" className="text-dark">Remote work</a>
              </li>
              <li>
                <a href="#!" className="text-dark">Remote learn</a>
              </li>
              <li>
                <a href="#!" className="text-dark">Virtual office</a>
              </li>
              <li>
                <a href="#!" className="text-dark">Virtual class</a>
              </li>
            </ul>
          </div>
          <div className="col-lg-2 col-md-6 mb-4 mb-md-0">
            ...
            <ul className="list-unstyled mb-0">
              ...
              <li>
                <a href="#!" className="text-dark">Fees and Payout</a>
              </li>
            </ul>
          </div>
          <div className="col-lg-2 col-md-6 mb-4 mb-md-0">
            <h5 className="footer-title mb-0">Communty</h5>

            <ul className="list-unstyled">
              <li>
                <a href="#!" className="text-dark">Event </a>
              </li>
              <li>
                <a href="#!" className="text-dark">Blog</a>
              </li>
              <li>
                <a href="#!" className="text-dark">Affiliates</a>
              </li>
            </ul>
          </div>
        </div>
      </div>
      <div className="container text-center copyright p-4 mt-4">
        © Copyright 2020 Powermix, All rights reserved.
      </div>
    </div>
  );
}
